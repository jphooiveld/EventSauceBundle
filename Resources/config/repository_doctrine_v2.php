...
return static function (ContainerConfigurator $container) {
    ...
    $services->set('jphooiveld_eventsauce.message_repository.doctrine', \EventSauce\MessageRepository\DoctrineV2MessageRepository\DoctrineUuidV4MessageRepository::class)
        ->private()
        ->args([
            '',

                        ...
                        ->arrayNode('doctrine')
                            ...
                            ->children()
                                ...
                                ->scalarNode('table_schema')
                                    ->info('Table schema to use: default or legacy')
                                    ->defaultValue('default')
                                    ->validate()
                                        ->ifNotInArray(['default', 'legacy'])
                                        ->thenInvalid('Invalid table schema provided. Valide table schemes: default, legacy')
                                    ->end()
                                ->end()
                                ->scalarNode('uuid_encoder')
                                    ->info('UUID encoder to use: string or binary')
                                    ->defaultValue('string')
                                    ->validate()
                                        ->ifNotInArray(['string', 'binary'])
                                        ->thenInvalid('Invalid UUID encoder provided. Valide UID encoders: string, binary')
                                    ->end()
                                ->end()
                            ->end()
                        ->end()
